 ...
 */ async function initScripts() {
    const items = _configJsonDefault.default.modules ? _configJsonDefault.default.modules.sort((a, b)=>a > b
    ) : [];
    const list = document.querySelector('.module-list');
    if (list) {
        const mappedItems = items.map((item)=>`<li><a href="/${item}.html">${item}</a></li>`
        ).join('');
...
},{"../config.json":"bS3N0","./app.scss":"eb0vK","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./module-js/*":"kTxKD","./module-styles/*":"9krPi","swiper/swiper.scss":"3GX5N"}],"bS3N0":[function(require,module,exports) {
module.exports = JSON.parse("{\"modules\":[\"hero\",\"teaser\"]}");

},{}],"eb0vK":[function() {},{}],"ciiiV":[function(require,module,exports) {
...
},{}],"kTxKD":[function(require,module,exports) {
const _temp0 = require("./hero.js");
const _temp1 = require("./teaser.js");
module.exports = {
    "hero.js": _temp0,
    "teaser.js": _temp1
};

},{"./hero.js":"kdZBw","./teaser.js":"aNF3q"}],"kdZBw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
if (el) Array.from(el).forEach((element)=>{
    console.log(`${moduleName} script initialized`, element);
    const swiper = new _swiperDefault.default(element, {
        loop: true
    });
});
...
},{"../../shared/create-shadow.js":"gVEWj","../../shared/effect-init.js":"3n9Bc","../../shared/effect-target.js":"bWadk","../../shared/effect-virtual-transition-end.js":"iCFVL","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"aNF3q":[function(require,module,exports) {
...
},{}],"9krPi":[function(require,module,exports) {
const _temp0 = require("./hero.scss");
const _temp1 = require("./teaser.scss");
module.exports = {
    "hero.scss": _temp0,
    "teaser.scss": _temp1
};

},{"./hero.scss":"lWZxl","./teaser.scss":"4ypOG"}],"lWZxl":[function() {},{}],"4ypOG":[function() {},{}],"3GX5N":[function() {},{}]},["1Mq12","5HwUs"], "5HwUs", "parcelRequire8a34")

//# sourceMappingURL=hero.d56a3cb1.js.map
